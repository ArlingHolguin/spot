...
const ShortenerInput = forwardRef<HTMLDivElement, {}>((props, ref: ForwardedRef<HTMLDivElement>) => {
    const [form] = Form.useForm();
    const service = new Service();
    //obtener el dominio actual para hacer las peticiones
    ...
    return (
        <div ref={ref} className="flex flex-col justify-center items-center mt-48">
            <Form
            ...
            <div className="mt-8">
                <h2 className="text-lg font-semibold text-gray-700 mb-2">Últimas urls Acortadas</h2>
                <Table
                className='w-full min-w-[400px] md:min-w-[850px] md:max-w-[850px]'
                    dataSource={urlList}
                    columns={columns}
